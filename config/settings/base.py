...
MIDDLEWARE = [
    ...
    'apps.journal.middleware.UserEncryptionMiddleware',  # Load user encryption key
...
# CORS Configuration (for iOS app and development)
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Reflekt API',
    'DESCRIPTION': 'REST API for the Reflekt journaling application',
    'VERSION': '1.0.0',
